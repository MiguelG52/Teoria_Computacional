...
int cambiaEstado(char letra, int estado){//recibe como parametro letra y estado actual
    switch(estado){
...
int main(void){
    char expresion[30];
    int estadoInicial = 0, estadoFinal = 0, i=0, opc=1;
    printf("\n*******Automata 1*********");
