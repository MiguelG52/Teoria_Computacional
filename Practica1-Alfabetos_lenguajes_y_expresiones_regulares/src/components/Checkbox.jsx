    ...
    <div className="flex justify-center mt-10 ">
        <div className='flex gap-5 justify-center'>
            <div >
                ...
                <label className="form-check-label inline-block text-gray-100" htmlFor="flexRadioDefault1">
                    Individual
                </label>
            </div>
            <div >
                ...
                <label className="form-check-label inline-block text-gray-100" htmlFor="flexRadioDefault2">
                    Rango
                </label>
            </div>
        </div>
